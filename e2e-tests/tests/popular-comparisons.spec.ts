...
test.describe("Popular GPU Comparisons", () => {
  test("all comparison links on homepage should return 200", async ({
    page,
  }) => {
    // Go to homepage
    await page.goto("/");
  ...
  test("comparison links on /gpu/compare landing page should return 200", async ({
    page,
  }) => {
