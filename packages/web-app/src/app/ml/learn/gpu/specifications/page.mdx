...
<div className="row g-4 py-4 row-cols-1 row-cols-lg-3">
  <Feature title="Tensor Cores: The Engines of Deep Learning" icon="cpu">
    ...
    performance.
    <br />
    _Use our real-time [price per Tensor Core GPU
    ranking](/ml/learn/gpu/ranking/tensor-cores) to find the best performance
    for your money._
  </Feature>
  <Feature title="Memory Capacity: Storing the Data" icon="memory">
    ...
    <br />
    _Use our real-time [price per GB GPU
    ranking](/ml/learn/gpu/ranking/memory-gb) to find the best performance for
    your money._
  </Feature>
  <Feature
  ...
  >
    ...
    <br />
    _Use our real-time [price per GB GPU
    ranking](/ml/learn/gpu/ranking/memory-bandwidth-gbs) to find the best
    performance for your money._
  </Feature>
</div>
...
<div className="row g-4 pt-4 row-cols-1 row-cols-lg-3">
  <Feature title="FP32 Performance" icon="graph-up">
    ...
    <br />
    _Use our real-time [price per FP32 FLOPs GPU
    ranking](/ml/learn/gpu/ranking/fp32-flops) to find the best performance for
    your money._
  </Feature>
  <Feature title="FP16 Performance" icon="lightning">
    ...
    <br />
    _Use our real-time [price per FP16 FLOPs GPU
    ranking](/ml/learn/gpu/ranking/fp16-flops) to find the best performance for
    your money._
  </Feature>
  <Feature title="INT8 Performance" icon="hdd-stack">
    ...
    <br />
    _Use our real-time [price per INT8 TOPs GPU
    ranking](/ml/learn/gpu/ranking/int8-tops) to find the best performance for
    your money._
  </Feature>
</div>
...
<div className="my-4">
  <em>
    ...
    <Link href="/ml/shop/gpu">here on GPU Poet</Link>.
  </em>
</div>
