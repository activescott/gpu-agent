 ...
 * page content. The eBay Partner Network disclosure guidelines require the
 * disclosure either at the top of the site or adjacent to every eBay
 * promotional link; this bar satisfies the former on every route.
 *
