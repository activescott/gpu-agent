...
test.describe("Gaming Benchmark Sorting", () => {
  test("gaming benchmarks should be sorted with resolutions: 4K first, then 1440p, then 1080p", async ({
    page,
  }) => {
    ...
    const gamingBenchmarksButton = page.locator("button.nav-link", {
