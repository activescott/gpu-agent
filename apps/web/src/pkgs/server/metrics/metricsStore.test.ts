import { updateMetrics, getMetrics, hasMetrics, getPrometheusMetrics, resetMetrics } from './metricsStore'
...
describe('metricsStore', () => {
  ...
  describe('updateMetrics', () => {
    ...
    it('should update timestamp when metrics are stored', () => {
      ...
      expect(metrics.timestamp.getTime()).toBeGreaterThanOrEqual(beforeUpdate.getTime())
      expect(metrics.timestamp.getTime()).toBeLessThanOrEqual(afterUpdate.getTime())
    })
  })
